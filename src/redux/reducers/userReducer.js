...
export default function userReducer(state = initialState, { type, payload }) {
  switch (type) {
    ...
    case TYPES.INTERESTED_CATEGORIES_LOADING:
      return {
        ...state,
        isLoading: true,
        error: null,
    ...
    case TYPES.INTERESTED_CATEGORIES_SUCCESS:
      return {
        ...state,
        isLoading: false,
        profile: {
          ...state.profile,
          interestedCategoriesList: payload.categories,
        },
      };
    ...
    case TYPES.INTERESTED_CATEGORIES_FAIL:
      return {
        ...state,
        isLoading: false,
        profile: {},
