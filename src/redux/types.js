...
//ask question
export const ASKQUESTION_LOADING = "ASKQUESTION_LOADING";
export const ASKQUESTION_SUCCESS = "ASKQUESTION_SUCCESS";
export const ASKQUESTION_RESET = "ASKQUESTION_RESET";
export const ASKQUESTION_FAIL = "ASKQUESTION_FAIL";

//view solution
export const VIEWSOLUTION_LOADING = "VIEWSOLUTION_LOADING";
export const VIEWSOLUTION_SUCCESS = "VIEWSOLUTION_SUCCESS";
export const VIEWSOLUTION_RESET = "VIEWSOLUTION_RESET";
export const VIEWSOLUTION_FAIL = "VIEWSOLUTION_FAIL";
